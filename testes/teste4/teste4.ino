/*===============================================================================================
  ...
  teste4: envia um pacote LoRa onde o terceiro byte (ALARMID) não é conhecido pelo master (gateway).
...
#if DEBUG >=1 
  Serial.println("Transmitindo mensagem com ALARMID incorreto.");
#endif
