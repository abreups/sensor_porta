/*===============================================================================================
  ...
  teste3: envia um pacote LoRa onde o primeiro byte não é conhecido pelo master (gateway).
...
void setup() {
...
#if DEBUG >=1 
  Serial.println("Transmite primeiro pacote.");
#endif
  // transmite um pacote com alarme de porta
  if(portaAberta) {
      // prepara mensagem de alarme que porta foi aberta
      tx_buffer[tx_buffer_head++] = 0x05;           // 0x05 é um byte desconhecido para o mstaer (gateway)
...
#if DEBUG >=1 
  Serial.println("Primeiro pacote transmitido.");
#endif


#if DEBUG >=1 
  Serial.println("Transmite segundo pacote.");
#endif
  // transmite um pacote com alarme de porta
  if(portaAberta) {
      // prepara mensagem de alarme que porta foi aberta
  ...
  sendBuffer(); // transmite
#if DEBUG >=1 
  Serial.println("Segundo pacote transmitido.");
#endif


#if DEBUG >=1 
  Serial.println("Transmite terceiro pacote.");
#endif
  // transmite um pacote com alarme de porta
  if(portaAberta) {
      // prepara mensagem de alarme que porta foi aberta
  ...
  sendBuffer(); // transmite
#if DEBUG >=1 
  Serial.println("Terceiro pacote transmitido.");
#endif
